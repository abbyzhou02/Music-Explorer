...
var DialogOverlay = React2.forwardRef(
  (props, forwardedRef) => {
    ...
    return context.modal ? (0, import_jsx_runtime2.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime2.jsx)(DialogOverlayImpl, __spreadProps(__spreadValues({}, overlayProps), { ref: forwardedRef })) }) : null;
  }
);
...
var DialogTitle = React2.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime2.jsx)(Primitive.h2, __spreadProps(__spreadValues({ id: context.titleId }, titleProps), { ref: forwardedRef }));
  }
);
...
var DialogDescription = React2.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime2.jsx)(Primitive.p, __spreadProps(__spreadValues({ id: context.descriptionId }, descriptionProps), { ref: forwardedRef }));
  }
);
