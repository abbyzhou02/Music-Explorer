...
function createSlot(ownerName) {
  ...
  const Slot2 = React7.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime2.jsx)(SlotClone, __spreadProps(__spreadValues({}, slotProps), { ref: forwardedRef, children: React7.isValidElement(newElement) ? React7.cloneElement(newElement, void 0, newChildren) : null }));
    }
...
var DismissableLayerBranch = React11.forwardRef((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime4.jsx)(Primitive.div, __spreadProps(__spreadValues({}, props), { ref: composedRefs }));
});
...
var FocusScope = React12.forwardRef((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime5.jsx)(Primitive.div, __spreadProps(__spreadValues({ tabIndex: -1 }, scopeProps), { ref: composedRefs, onKeyDown: handleKeyDown }));
});
...
var Portal = React13.forwardRef((props, forwardedRef) => {
  ...
  return container ? import_react_dom.default.createPortal((0, import_jsx_runtime6.jsx)(Primitive.div, __spreadProps(__spreadValues({}, portalProps), { ref: forwardedRef })), container) : null;
});
...
//# sourceMappingURL=chunk-OJSMTCXK.js.map
