...
function createRouter(init) {
  ...
  function callLoadersAndMaybeResolveData(state2, matches, matchesToLoad, fetchersToLoad, request) {
    return __async(this, null, function* () {
      ...
      let fetcherResultsPromise = Promise.all(fetchersToLoad.map((f) => __async(null, null, function* () {
...
function callDataStrategyImpl(dataStrategyImpl, type, state, request, matchesToLoad, matches, fetcherKey, manifest, mapRouteProperties2, requestContext) {
  return __async(this, null, function* () {
    ...
    let dsMatches = matches.map((match, i) => {
      ...
      let resolve = (handlerOverride) => __async(null, null, function* () {
...
function RouterProvider(_ref) {
  ...
  React2.useEffect(() => {
    if (renderDfd && pendingState && router.window) {
      ...
      let transition2 = router.window.document.startViewTransition(() => __async(null, null, function* () {
        optInStartTransition(() => setStateImpl(newState));
        yield renderPromise;
      }));
